        ...
        <div class="row">
          ...
          <div class="col-6">
            <div class="Chart">
              ...
              <bar-example
                v-if="this.moyenne_intervention"
                title="Moy.Intervention"
                :moyenne_intervention="this.moyenne_intervention"
                :key="componentKey[1]"
              ></bar-example>
              <div v-else class="loader"></div>
            </div>
          ...
          <div class="col-6">
            <div class="Chart">
              ...
              <line-example
                v-if="this.total_feux"
                title="Total Feux"
                :total_feux="this.total_feux"
                :key="componentKey[3]"
              ></line-example>
              <div v-else class="loader"></div>
            </div>
...
export default {
  ...
  methods: {
    initialize_graph: function() {
      ...
      axios
        .get("/json/moyenne_temps_intervention.json?new=true")
        .then(response => {
